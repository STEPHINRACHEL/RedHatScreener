...
Create new user with the details being passed in request body.
...
* **Sample Call:**
  ...
  $.ajax({
    ...
    data: {
              ...
              salt: '546565a',
              md5: '545ss5qewe45545',
              sha1: 'dwd56565wdwd6w6w1wd661wddf',
              sha256: wd54656wdw2d1wdd155464wdwdwdqwq5121254,
              registered: 6565656,
              dob: 332323,
              phone: '123-256-563',
              cell: '012-456-789',
 ...
 **Update User**
----
  Updates user details with selected id.
...
* **Sample Call:**
  ...
  **Delete User**
----
  Delete the user having the id selected.
